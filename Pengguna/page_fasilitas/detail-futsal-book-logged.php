...
<body>
    ...
    <div class="form-booking">
        ...
        <form action="detail-futsal-book-logged.php" method="POST">
            ...
            <input type="hidden" name="session_instansi" id="session_instansi" value="<?php echo $_SESSION['Asal_Instansi']; ?>">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p id="labelTarif">Tarif: </p> <span id="tarif" style="color:#0d7a6f" name="tarif"></span> <br> <br>
                            ...
                            <script>
                            var valueNotes = document.getElementById("labelTarif");
                            var session_status = document.getElementById("session_instansi").value;
                            if(session_status == 'Unpar'){
                                valueNotes.innerText = "Tarif Khusus Sivitas Unpar (Diskon 10%):";
                            }
                            else{
                                valueNotes.innerText = "Tarif:"
                            }
                            </script>
                            <br>
                            <p>Bayar ke nomor rekening : BCA 76367281 a/n Pasaga Unpar.<br>Harap bayar sesuai tarif yang tertera untuk memudahkan verifikasi pembayaran. </p>
                        </div>

                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" name='btnConfirm' value='send'>Confirm Booking</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    var session = document.getElementById("session_instansi").value;
    console.log(session);
    if(session == 'Umum'){
       if(jamBooking <= 14){
        //kalo weekend
    ...
    //Harga jika Sivitas Unpar
    else if(session == 'Unpar'){
       if(jamBooking <= 14){
        //kalo weekend
        if((yourDate.getDay() == 6 || yourDate.getDay() == 0)){
            if(hours == 02 && lunas.checked){
                valueTarif.textContent = "Rp." + ((weekend_14*2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 02 && dp.checked){
                valueTarif.textContent = "Rp." + (((weekend_14*2)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }

            if(hours == 04 && lunas.checked){
                valueTarif.textContent = "Rp." + ((weekend_14*4)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 04 && dp.checked){
                valueTarif.textContent = "Rp." + (((weekend_14*4)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }

            if(hours == 06 && lunas.checked){
                valueTarif.textContent = "Rp." + ((weekend_14*6)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 06 && dp.checked){
                valueTarif.textContent = "Rp." + (((weekend_14*6)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }

            if(hours == 08 && lunas.checked){
                valueTarif.textContent = "Rp." + ((weekend_14*8)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 08 && dp.checked){
                valueTarif.textContent = "Rp." + (((weekend_14*8)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
        } //nutup if weekend
        ...
        //kalo jumat
            ...
            if(hours == 02 && lunas.checked){
                valueTarif.textContent = "Rp." + ((jumat_14*2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 02 && dp.checked){
                valueTarif.textContent = "Rp." + (((jumat_14*2)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }

            if(hours == 04 && lunas.checked){
                valueTarif.textContent = "Rp." + ((jumat_14*4)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 04 && dp.checked){
                valueTarif.textContent = "Rp." + (((jumat_14*4)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }

            if(hours == 06 && lunas.checked){
                valueTarif.textContent = "Rp." + ((jumat_14*6)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 06 && dp.checked){
                valueTarif.textContent = "Rp." + (((jumat_14*6)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }

            if(hours == 08 && lunas.checked){
                valueTarif.textContent = "Rp." + ((jumat_14*8)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 08 && dp.checked){
                valueTarif.textContent = "Rp." + (((jumat_14*8)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
        } //nutup if jumat
        ...
        //kalo weekday
            ...
            if(hours == 02 && lunas.checked){
                valueTarif.textContent = "Rp." + ((weekday_14*2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 02 && dp.checked){
                valueTarif.textContent = "Rp." + (((weekday_14*2)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }

            if(hours == 04 && lunas.checked){
                valueTarif.textContent = "Rp." + ((weekday_14*4)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 04 && dp.checked){
                valueTarif.textContent = "Rp." + (((weekday_14*4)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }

            if(hours == 06 && lunas.checked){
                valueTarif.textContent = "Rp." + ((weekday_14*6)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 06 && dp.checked){
                valueTarif.textContent = "Rp." + (((weekday_14*6)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }

            if(hours == 08 && lunas.checked){
                valueTarif.textContent = "Rp." + ((weekday_14*8)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 08 && dp.checked){
                valueTarif.textContent = "Rp." + (((weekday_14*8)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
        } //nutup if weekday
    } //nutup if jam booking <=14
        ...
        if((yourDate.getDay() == 6 || yourDate.getDay() == 0)){
            if(hours == 02 && lunas.checked){
                valueTarif.textContent = "Rp." + ((weekend_17*2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 02 && dp.checked){
                valueTarif.textContent = "Rp." + (((weekend_17*2)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
        }

        else if((yourDate.getDay() == 5)){
            if(hours == 02 && lunas.checked){
                valueTarif.textContent = "Rp." + ((jumat_17*2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 02 && dp.checked){
                valueTarif.textContent = "Rp." + (((jumat_17*2)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
        }

        else{
            if(hours == 02 && lunas.checked){
                valueTarif.textContent = "Rp." + ((weekday_17*2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 02 && dp.checked){
                valueTarif.textContent = "Rp." + (((weekday_17*2)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
        }
    }
        ...
        if((yourDate.getDay() == 6 || yourDate.getDay() == 0)){
            if(hours == 02 && lunas.checked){
                valueTarif.textContent = "Rp." + ((weekend_1618)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 02 && dp.checked){
                valueTarif.textContent = "Rp." + (((weekend_1618)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
        }

        else if((yourDate.getDay() == 5)){
            if(hours == 02 && lunas.checked){
                valueTarif.textContent = "Rp." + ((jumat_1618)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 02 && dp.checked){
                valueTarif.textContent = "Rp." + (((jumat_1618)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
        }

        else{
            if(hours == 02 && lunas.checked){
                valueTarif.textContent = "Rp." + ((weekday_1618*2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 02 && dp.checked){
                valueTarif.textContent = "Rp." + (((weekday_1618*2)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
        }
    }
        ...
        if((yourDate.getDay() == 6 || yourDate.getDay() == 0)){
            if(hours == 02 && lunas.checked){
                valueTarif.textContent = "Rp." + ((weekend_21*2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 02 && dp.checked){
                valueTarif.textContent = "Rp." + (((weekend_21*2)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
        }

        else if((yourDate.getDay() == 5)){
            if(hours == 02 && lunas.checked){
                valueTarif.textContent = "Rp." + ((jumat_21*2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 02 && dp.checked){
                valueTarif.textContent = "Rp." + (((jumat_21*2)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
        }

        else{
            if(hours == 02 && lunas.checked){
                valueTarif.textContent = "Rp." + ((weekday_21*2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
            else if(hours == 02 && dp.checked){
                valueTarif.textContent = "Rp." + (((weekday_21*2)/2)*0.9).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            }
        }
    }
    } //kurawal untuk Unpar
