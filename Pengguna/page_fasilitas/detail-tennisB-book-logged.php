...
<body>
    ...
    <div class="form-booking">
        ...
        <form action="detail-tennisB-book-logged.php" method="POST">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" name='btnConfirmTennisB' value='send'>Confirm Booking</button>
                        </div>
                    </div>
                </div>
            </div>
