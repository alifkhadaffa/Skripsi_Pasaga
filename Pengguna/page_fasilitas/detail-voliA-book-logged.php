    ...
    <style>
        *{
        ...
        .header-photo{
            width: 80%;
            height: 600px;
            background: url(../../Image/voliB.jpg);
...
<body>
    ...
    <div class="form-booking">
        ...
        <form action="detail-voliA-book-logged.php" method="POST">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" name='btnConfirmVoliA' value='send'>Confirm Booking</button>
                        </div>
                    </div>
                </div>
            </div>
