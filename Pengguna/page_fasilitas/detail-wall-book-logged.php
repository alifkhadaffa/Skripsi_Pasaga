    ...
    <style>
        *{
        ...
        .header-photo{
            width: 80%;
            height: 600px;
            background: url(../../Image/wall-climb.jpg);
...
<body>
    ...
    <section>
        ...
        <div class="gallery">
            ...
            <div id="slider">
                <figure>
                    <img src="../../Image/wall-climb.jpg">
                    <img src="../../Image/wall2.jpg" style="width:15%">
                    <img src="../../Image/wall-climb.jpg">
                    <img src="../../Image/wall2.jpg"style="width:15%">
                    <img src="../../Image/wall-climb.jpg">
                </figure>
    ...
    <div class="tarif">
        ...
        <table id="table-harga">
            <tr>
                <th>06.00 - 18.00 WIB</th>
                <th>06.00 - 18.00 WIB</th>
                <th>06.00 - 18.00 WIB</th>
            </tr>
            <tr>
                <td>Weekday : <?php echo "Rp".$row["Tarif_Per_Jam(Weekday 06.00-14.00)"]; ?></td>
                <td>Jumat : <?php echo "Rp".$row["Tarif_Per_Jam(Weekday 14.00-17.00)"]; ?></td>
                <td>Weekend : <?php echo "Rp".$row["Tarif_Per_Jam(Weekday 17.00-21.00)"]; ?></td>
            </tr>
        </table>
    </div>
    ...
    <div class="form-booking">
        ...
        <form action="detail-wall-book-logged.php" method="POST">
            ...
            <input type="time" name="jam-mulai" id="jam-mulai" step="3600" min="06:00" max="18:00" onchange="handler()"> <br> <br>
            
            <label for="">Pilih jam selesai</label> <br>
            <input type="time" name="jam-selesai" id="jam-selesai" step="3600" min="06:00" max="18:00" onchange="handler()"> <br> <br>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" name='btnConfirmWall' value='send'>Confirm Booking</button>
                        </div>
                    </div>
                </div>
            </div>
